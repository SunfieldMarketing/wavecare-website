  ...
  const layout: any[] = [
    ...
    },
    {
      ...
      cards: [
        ...
        {
          number: '05',
          title: 'Ad Management, SEO and Paid Search',
          body: 'Be found first when families start searching. We manage your Google Ads, paid search, and SEO with healthcare-specific care, tuning campaigns week-by-week so you know what every dollar did.',
    ...
    },
    {
      ...
      tone: 'deeper',
      textTone: 'on-dark',
      eyebrow: 'Ad Management & SEO',
      title: 'Be found first when families start searching.',
      body: 'Families choose a community long before they ever call, and the search bar is where it starts. Wavecare manages your Google Ads, paid search, and SEO with the same healthcare-specific care we bring to everything else.',
      bullets: [
        { text: 'Keywords built from real senior care searches' },
        { text: 'Negative keywords that filter out wasted clicks' },
        { text: 'Local SEO + Google Business Profile optimization' },
        { text: 'Full-funnel conversion tracking tied to real revenue' },
      ],
      buttons: [btn('Learn More', '/digital-marketing')],
      mediaType: 'video',
