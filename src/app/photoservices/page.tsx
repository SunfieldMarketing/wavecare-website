...
export default function PhotoServices() {
  ...
  return (
    <>
      ...
      {/* ========== CONTEXT ========== */}
      <section className="panel deep sec-pad">
        <div className="container phero-in" style={{ gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'flex-end', paddingBottom: '40px' }}>
          ...
          <div className="ctx" data-reveal style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center' }}>
            <div className="ctx-stage" style={{ position: 'relative', height: '100%', minHeight: '480px', width: '115%', marginLeft: '-7.5%' }}>
              
              {/* WEBSITE WIDGET */}
              <div className={`ctx-scene ${ctxTab === 0 ? 'on' : ''}`} style={{ alignItems: 'flex-end' }}>
                <div style={{ maxWidth: '800px', width: '100%', padding: '32px', background: '#0b3f37', border: '1px solid var(--soft)', borderRadius: '20px', boxShadow: '0 30px 60px -25px rgba(0,0,0,.6)' }}>
                  <div style={{ borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)', overflow: 'hidden', background: '#062a24', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}>
                    <div style={{ height: '36px', background: '#08322c', display: 'flex', alignItems: 'center', padding: '0 16px', gap: '8px', borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
                      <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#ff5f56' }}></div>
                      <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#ffbd2e' }}></div>
                      <div style={{ width: '10px', height: '10px', borderRadius: '50%', background: '#27c93f' }}></div>
                    </div>
                    <div style={{ aspectRatio: '16/10', overflow: 'hidden' }}>
                      <img src="/images/park_gardens_website.png" alt="Website Design" style={{ width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'top' }} />
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className={`ctx-scene ${ctxTab === 1 ? 'on' : ''}`} style={{ alignItems: 'flex-end' }}>
                <div style={{ maxWidth: '800px', width: '100%', padding: '40px 32px', background: '#0b3f37', border: '1px solid var(--soft)', borderRadius: '20px', boxShadow: '0 30px 60px -25px rgba(0,0,0,.6)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                  <img src="/images/harvest_acres_brochure.jpg" alt="Brochure Outside" style={{ width: '42%', borderRadius: '4px', boxShadow: '0 20px 40px rgba(0,0,0,0.6)', transform: 'rotate(-3deg) translateY(10px)', zIndex: 1 }} />
                  <img src="/images/gardens_brochure_inside.png" alt="Brochure Inside" style={{ width: '50%', borderRadius: '4px', boxShadow: '0 25px 50px rgba(0,0,0,0.7)', transform: 'rotate(4deg) translateY(-10px)', zIndex: 2, marginLeft: '-15%' }} />
                </div>
              </div>
